...
import dow from "../Pictures/download.png";
  ...
  return (
    <div>
      ...
      <div className="page2">
        ...
        <div className="make">
          Make it <span className="makeYour"><img src='./roller.png' width="50px"/>Yours</span>
          and take <br />
          it with you
        </div>
...
<img width="70" height="70" src="https://img.icons8.com/ios/50/000000/add--v1.png" alt="add--v1"/>
</div>
            </div>
          </div>
          ...
          <div className="sec6sub2">
            <div className="box3">
              ...
              <div className="sideimage2">
                <img src="https://img.icons8.com/ios/50/000000/add--v1.png" width="70px" height="70px"/>
              </div>
